...
int crlev=4;
////////////////
void input();void first_load();void delay();void gameover();
int level3();int level1();int level2();int timer2();
int rang2();int bomb();int eat();int menu();int chap_mar();
int Logo();int stop();int res();
...
s1--;s2--;s3--;s4--;s5--;s6--;s7--;s8--;s9--;
  ...
  if (s1<=34 && s1>=4)
     ...
     printf("\033[3;104;30m\033[%d;%dH%s\033[0m", s1-4, 57, "Programer");
     }

     if (s2<=34 && s2>=4)
     {
     printf("\033[3;104;97m\033[%d;%dH%s\033[0m", s2-4, 53, "Mohammad Hossein");
      printf("\033[3;104;93m\033[%d;%dH%s\033[0m", s2-3, 35, "                                                   ");
     printf("\033[3;104;97m\033[%d;%dH%s\033[0m", s2-2, 58, "Fadavi");
      printf("\033[3;104;93m\033[%d;%dH%s\033[0m", s2-1, 35, "                                                   ");
     }
...
///////////////////////////////////////////////////////res
printf("\033[3;40;97m\033[%d;%dH%s\033[0m", 3, 4, "|1) New Game  ?");
printf("\033[3;40;97m\033[%d;%dH%s\033[0m", 4, 4, "|2) Continue  ?");
printf("\033[3;40;97m\033[%d;%dH%s\033[0m", 5, 4, "|3) Main Menu ?");
char men='4';
while(1)
{
   men= _getch();
